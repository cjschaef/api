...
// +kubebuilder:validation:Enum="";AWS;Azure;BareMetal;GCP;Libvirt;OpenStack;None;VSphere;oVirt;
...
type IBMCloudPlatformStatus struct {
	...
	DNSInstanceCRN string `json:"dnsInstanceCRN,omitempty"`
        ...
        // service endpoints of an IBM Cloud service. These endpoints are populated from the
	// IBMCloudPlatformSpec, after validation by the Cluster Config Operator, and are
	// consumed by components within the cluster to reach the respective IBM Cloud Services.
        // +listType=map
        // +listMapKey=name
        // +optional
